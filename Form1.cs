...
namespace QuanLyDanhSachSvWithCode
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void TraCuuButton_Click(object sender, EventArgs e)
        {
            ...
            string found = InputTimKiem.Text;

           
            SinhVien sv = danhSachSinhVien.FirstOrDefault(s => s.MaSinhVien == found);

            if (sv != null)
            {
                
                OutputMSV.Text = sv.MaSinhVien;
                OutputTSV.Text = sv.TenSinhVien;
                OutputLop.Text = sv.LopHoc;
            }
            else
            {              
